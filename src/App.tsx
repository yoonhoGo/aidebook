...
function App() {
  ...
  function renderPage() {
    if (page === "dashboard") return <DashboardPanel onOpen={(selection) => { setWorkflowSelection(selection); navigate("workflow"); }} />;
    if (page === "workflow") return <WorkflowPanel initialSelection={workflowSelection} />;
